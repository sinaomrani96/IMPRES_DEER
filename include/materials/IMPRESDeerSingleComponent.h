 ...
 */
template <bool is_ad>
class IMPRESDeerSingleComponentTempl : public PorousFlowFluidPropertiesBaseTempl<is_ad>
{
public:
  static InputParameters validParams();

  IMPRESDeerSingleComponentTempl(const InputParameters & parameters);
...
typedef IMPRESDeerSingleComponentTempl<false> IMPRESDeerSingleComponent;
typedef IMPRESDeerSingleComponentTempl<true> ADIMPRESDeerSingleComponent;
