...
#include "IMPRESDeerDarcyVelocityMaterial.h"

registerMooseObject("IMPRES_DEERApp", IMPRESDeerDarcyVelocityMaterial);

InputParameters
IMPRESDeerDarcyVelocityMaterial::validParams()
{
...
void
IMPRESDeerDarcyVelocityMaterial::computeQpProperties()
{
  _darcy_velocity[_qp].resize(_num_phases);
