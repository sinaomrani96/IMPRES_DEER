...
#include "IMPRESDeerSingleComponent.h"
#include "SinglePhaseFluidProperties.h"


registerMooseObject("IMPRES_DEERApp", IMPRESDeerSingleComponent);
registerMooseObject("IMPRES_DEERApp", ADIMPRESDeerSingleComponent);

template <bool is_ad>
InputParameters
IMPRESDeerSingleComponentTempl<is_ad>::validParams()
{
...
template <bool is_ad>
void
IMPRESDeerSingleComponentTempl<is_ad>::initQpStatefulProperties()
{
...
template <bool is_ad>
void
IMPRESDeerSingleComponentTempl<is_ad>::computeQpProperties()
{
  Real velocity_abs;
  if (_compute_rho_mu)
  {
...
template class IMPRESDeerSingleComponentTempl<false>;
template class IMPRESDeerSingleComponentTempl<true>;
